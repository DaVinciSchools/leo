...
export function PostsTab() {
  ...
  >('highlightUserXs', {
    ...
    disabled: !schoolFilter?.getValue?.() ?? true,
  });
    ...
    <>
      <Grid container spacing={2} padding={2}>
        <Grid item xs={3}>
          <EducationFilters
            label="Filter Posts"
            districtField={districtFilter}
            schoolsField={schoolFilter}
